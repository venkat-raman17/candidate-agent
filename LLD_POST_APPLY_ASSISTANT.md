...
4. [Architecture Overview](#4-architecture-overview)
    4.1 [LangGraph Graphs](#41-langgraph-graphs)
    4.2 [MCP Component Architecture](#42-mcp-component-architecture)
...
6. [Key Data Flows](#6-key-data-flows)
    6.1 [Agent Startup — Tool Loading](#61-agent-startup--tool-loading)
    6.2 [Happy Path — Post-Apply Query](#62-happy-path--post-apply-query)
    6.3 [Profile Query Flow](#63-profile-query-flow)
    6.4 [SSE Streaming Path](#64-sse-streaming-path)
    6.5 [Downstream Call with Resilience](#65-downstream-call-with-resilience)
7. [Integration Design](#7-integration-design)
    7.1 [MCP Integration Steps — careers-ai-service to candidate-mcp](#71-mcp-integration-steps--careers-ai-service-to-candidate-mcp)
        7.1.1 [Initialize MCP registry during FastAPI lifespan startup](#711-initialize-mcp-registry-during-fastapi-lifespan-startup)
        7.1.2 [Load candidate-mcp tools at startup](#712-load-candidate-mcp-tools-at-startup)
    7.2 [MCP Protocol and TLS Handshake Optimisation](#72-mcp-protocol-and-tls-handshake-optimisation)
    7.3 [Downstream Service Contracts](#73-downstream-service-contracts)
8. [Security Design](#8-security-design)
    8.1 [App2App Signature Auth — careers-ai-service to candidate-mcp](#81-app2app-signature-auth--careers-ai-service-to-candidate-mcp)
    8.2 [App2App Signature Auth — candidate-mcp to Downstream Services](#82-app2app-signature-auth--candidate-mcp-to-downstream-services)
    8.3 [Security Principles](#83-security-principles)
9. [Resilience Design](#9-resilience-design)
    9.1 [Circuit Breaker — State Machine](#91-circuit-breaker--state-machine)
    9.2 [Retry Configuration](#92-retry-configuration)
    9.3 [Timeout Hierarchy](#93-timeout-hierarchy)
    9.4 [Graceful Degradation](#94-graceful-degradation)
10. [Observability Design](#10-observability-design)
    10.1 [Three-Layer Observability Stack](#101-three-layer-observability-stack)
    10.2 [Langfuse: LLM Tracing & Cost Management](#102-langfuse-llm-tracing--cost-management)
    10.3 [MMS (Managed Metrics Service): Service Metrics & SLOs](#103-mms-managed-metrics-service-service-metrics--slos)
    10.4 [MLS (Managed Log Search): Application Logs & Alerting](#104-mls-managed-log-search-application-logs--alerting)
    10.5 [Distributed Trace Propagation](#105-distributed-trace-propagation)
...
12. [Error Handling](#12-error-handling)
    12.1 [Error Envelope Contract](#121-error-envelope-contract)
    12.2 [Error Classification](#122-error-classification)
13. [Testing Strategy](#13-testing-strategy)
    13.1 [Test Layers](#131-test-layers)
    13.2 [Key Scenarios by Layer](#132-key-scenarios-by-layer)
14. [Deployment](#14-deployment)
    14.1 [Service Topology](#141-service-topology)
    14.2 [Health Checks](#142-health-checks)
